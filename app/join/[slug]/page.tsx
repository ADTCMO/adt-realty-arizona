...
const guides = {
  "newly-licensed": {
    ...
    embed: "https://www.canva.com/design/DAHNmITN8Hg/view?embed",
    publicUrl: "https://canva.link/newagentguide",
  },
  "developing-agent": {
    title: "Developing Agent",
    embed: "https://www.canva.com/design/DAHNn_aO8GQ/view?embed",
    publicUrl: "https://www.canva.com/d/TpqX8x9EPfdWv9k",
  },
  "productive-agent": {
    title: "Productive Agent",
    embed: "https://www.canva.com/design/DAHNoq1lq-Y/view?embed",
    publicUrl: "https://www.canva.com/d/ggyF5J1gTgLIF80",
  },
  leadership: {
    title: "Leadership",
    embed: "https://www.canva.com/design/DAHNhN5B25g/view?embed",
    publicUrl: "https://www.canva.com/d/1TJ9wvclvHuwMIf",
  },
} as const;
    ...
    <main className="guidePage">
      ...
      <section>
        ...
        <p className="embedFallback">
          ...
          <a href={guide.publicUrl} target="_blank" rel="noreferrer">
            Open the full guide
          </a>
          .
        </p>
